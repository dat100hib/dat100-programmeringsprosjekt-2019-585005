...
public class GPSUtils {
	...
	public static String formatDouble(double d) {
		...
		// TODO - START
		//Locate US m� fikses. m�tte googles av Johan 
		//vi m� bruke amerikansk formatering siden europeisk bli feil i dette tilfellet. ganske rart egentlig :)
